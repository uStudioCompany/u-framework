...
internal class JBDCNamedPreparedStatementSetParameterWithSetterTest : IntegrationTest() {

    init {

        "The `setParameter` function with `SqlParameterSetter` of the JBDCNamedPreparedStatement type" - {
