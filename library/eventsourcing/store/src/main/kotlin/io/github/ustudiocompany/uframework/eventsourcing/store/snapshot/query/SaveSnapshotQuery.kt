...
import io.github.ustudiocompany.uframework.eventsourcing.store.snapshot.query.SnapshotStoreMetadata.AGGREGATE_ID_COLUMN_NAME
import io.github.ustudiocompany.uframework.eventsourcing.store.snapshot.query.SnapshotStoreMetadata.AGGREGATE_ID_PARAM_NAME
import io.github.ustudiocompany.uframework.eventsourcing.store.snapshot.query.SnapshotStoreMetadata.SNAPSHOT_DATA_COLUMN_NAME
import io.github.ustudiocompany.uframework.eventsourcing.store.snapshot.query.SnapshotStoreMetadata.SNAPSHOT_DATA_PARAM_NAME
import io.github.ustudiocompany.uframework.eventsourcing.store.snapshot.query.SnapshotStoreMetadata.SNAPSHOT_HISTORY_COLUMN_NAME
import io.github.ustudiocompany.uframework.eventsourcing.store.snapshot.query.SnapshotStoreMetadata.SNAPSHOT_HISTORY_PARAM_NAME
import io.github.ustudiocompany.uframework.eventsourcing.store.snapshot.query.SnapshotStoreMetadata.SNAPSHOT_REVISION_COLUMN_NAME
import io.github.ustudiocompany.uframework.eventsourcing.store.snapshot.query.SnapshotStoreMetadata.SNAPSHOT_REVISION_PARAM_NAME
