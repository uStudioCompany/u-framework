...
internal object SnapshotRowMapper {
    ...
    private fun Row.history(serializer: HistorySerializer<String>): Result<History, EventSourceRepositoryErrors.Snapshot> =
    ...
    private fun String.deserializationHistory(serializer: HistorySerializer<String>): Result<History, EventSourceRepositoryErrors.Snapshot.History.Deserialization> =
