...
internal class DataChangeTrackingStepDeserializationTest : UnitTest() {

    init {

        "The data change tracking step" - {
            ...
            "when condition is present" - {
                ...
                "then should be return valid type" {
                    result shouldBe StepModel.DataChangeTracking(
                        id = STEP_ID,
                        condition = listOf(
                            PredicateModel(
    ...
    private companion object {
        ...
        private const val UISS = "mdm:entity"
