...
internal class RulesDeserializer(private val mapper: ObjectMapper) {
    ...
    sealed class Errors : Failure {
        ...
        class Deserialization(exception: Exception) : Errors() {
            ...
            override val description: String = "The error of deserialization JSON with rules. " + exception.message
