...
public sealed interface Value {
    ...
    public data class Literal(public val fact: JsonElement) : Value
    ...
    public data class Expression(public val expression: FeelExpression) : Value

    public data class EnvVars(public val name: EnvVarName) : Value

    public data class DataStruct(public val scheme: DataSchema) : Value
}
