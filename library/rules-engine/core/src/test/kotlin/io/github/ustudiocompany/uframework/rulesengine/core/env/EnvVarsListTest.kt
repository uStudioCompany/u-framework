...
internal class EnvVarsListTest : UnitTest() {

    init {

        "The `EnvVarsList` type" - {

            "when environment variables is empty" - {
                val envVars = envVarsListOf()
            ...
            "when environment variables created from pairs" - {
                ...
                "when some pair is passed" - {
                    ...
                    "when passing unique pairs" - {
                        ...
                        val envVars = envVarsListOf(FIRST_ENV_VAR_NAME to first, SECOND_ENV_VAR_NAME to second)
                    ...
                    "when passing non unique pairs" - {
                        val first = JsonElement.Text(FIRST_ENV_VAR_VALUE)
                        val second = JsonElement.Text(SECOND_ENV_VAR_VALUE)
                        val envVars = envVarsListOf(FIRST_ENV_VAR_NAME to first, FIRST_ENV_VAR_NAME to second)
